      ...
      <div className="bg-card border border-border rounded-3xl overflow-hidden shadow-sm">
        ...
        <div className="p-2 flex flex-col gap-1">
              ...
              <div className="flex justify-between items-center p-4">
                ...
                <button 
                  ...
                  className={cn(
                    ...
                    notificationSettings.timer ? "bg-primary" : "bg-secondary"
                  )}
                >
                  <div className={cn(
                    "absolute top-1 w-3 h-3 rounded-full bg-white transition-all",
                    notificationSettings.timer ? "left-6" : "left-1"
                  )} />
                </button>
              </div>
              <div className="flex justify-between items-center p-4">
                ...
                <button 
                  ...
                  className={cn(
                    "w-10 h-5 rounded-full transition-colors relative",
                    notificationSettings.tasks ? "bg-primary" : "bg-secondary"
                  )}
                >
                  <div className={cn(
                    "absolute top-1 w-3 h-3 rounded-full bg-white transition-all",
                    notificationSettings.tasks ? "left-6" : "left-1"
                  )} />
                </button>
              </div>
            </>
          ...
          <button 
            ...
            className="w-full flex items-center gap-4 p-4 hover:bg-red-500/5 rounded-xl transition-colors text-left mt-2"
          >
